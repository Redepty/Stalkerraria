...
namespace Stalkerraria.Content.Buffs
{
    ...
    public class RadiationDebuff2 : ModBuff
    {
        ...
        {
            player.GetModPlayer<RadiationDebuff2Player>().lifeRegenDebuff = true;
        }
    }

    public class RadiationDebuff2Player : ModPlayer
    {
        ...
        public class Radiation2DebuffNPC : GlobalNPC
        {
            public override void ModifyHitByProjectile(NPC npc, Projectile projectile, ref NPC.HitModifiers modifiers)
            {
                ...
                if (npc.HasBuff<RadiationDebuff2>())
                {
