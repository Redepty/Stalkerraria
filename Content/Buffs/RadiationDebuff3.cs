...
namespace Stalkerraria.Content.Buffs
{
    ...
    public class RadiationDebuff3 : ModBuff
    {
        ...
        {
            player.GetModPlayer<RadiationDebuff3Player>().lifeRegenDebuff = true;
        }
    }

    public class RadiationDebuff3Player : ModPlayer
    {
        ...
        public class Radiation3DebuffNPC : GlobalNPC
        {
            public override void ModifyHitByProjectile(NPC npc, Projectile projectile, ref NPC.HitModifiers modifiers)
            {
                ...
                if (npc.HasBuff<RadiationDebuff3>())
                {
