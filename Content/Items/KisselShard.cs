...
{
    public class KisselShard : ModItem
    {
        ...
        {
            CreateRecipe(3)
                .AddIngredient(ModContent.ItemType<KisselArt>())
                .AddTile(TileID.Anvils)
                .Register();

            CreateRecipe(5)
                .AddIngredient(ModContent.ItemType<BubbleArt>())
                .AddTile(TileID.Anvils)
                .Register();

            CreateRecipe(7)
                .AddIngredient(ModContent.ItemType<PellicleArt>())
                .AddTile(TileID.Anvils)
                .Register();
        }
    }
