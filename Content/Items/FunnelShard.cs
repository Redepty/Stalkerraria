...
{
    public class FunnelShard : ModItem
    {
        ...
        {
            CreateRecipe(3)
                .AddIngredient(ModContent.ItemType<BloodStoneArt>())
                .AddTile(TileID.Anvils)
                .Register();

            CreateRecipe(5)
                .AddIngredient(ModContent.ItemType<BileStoneArt>())
                .AddTile(TileID.Anvils)
                .Register();

            CreateRecipe(7)
                .AddIngredient(ModContent.ItemType<PacifierArt>())
                .AddTile(TileID.Anvils)
                .Register();
        }
    }
